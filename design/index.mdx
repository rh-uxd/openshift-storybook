...
| Designer | Area of expertise |
| ------------------------- | ------------------ |
| Serena Nichols | Dev perspective, Pipelines & Serverless 
| Veethika Mishra | Topology 
| Parvathy Vijayakumary Ramachandran | Dev perspective & Add flows / Dev catalog | 
| Brigid Gliwa | Pipelines & Serverless |
| Beau Morley | Che / CodeReady workspaces
| Colleen Hart | Admin perspective & OLM |
| Brie Mignano | Admin perspective
| Chris Shinn | Monitoring |
| Peter Kreuser | OLM & Quay |
| Cameron Britt | OCM |
| Liz Blanchard | Multicluster
| Andy Braren | Multicluster 
| Matt Carleton | CNV
| Ran Elimelech | CNV
| Yifat Friman Menchik | CNV
| Yuval Galanti | Storage
| Shiri Mordechay | Storage
| Michael Celedonia | Visuals
| Mary Shakshober | Visuals
| Sunil Malagi | Visuals
| Rachael Petrie | PatternFly
